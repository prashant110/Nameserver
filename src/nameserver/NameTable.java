 ...
 * @author Prashu
 */
// Helper class for storing URL of nodes
class Url
{
    String name;
    String host;
...
public class NameTable {
    private final ArrayList<Url> url = new ArrayList<>(); // to store node address
    
    int search(String s) {
        // search and return index of node by name
    ...
    int search(int id)
    {
        // search and return index of node by id
        for (int i = 0; i < url.size(); i++)
